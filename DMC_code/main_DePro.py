...
def main_worker(ngpus_per_node, args):
    ...
    traindir = 'output_file_pre.txt'	# The path of the train feature vectors generated by opc_trans_sen.py
    valdir = 'output_file_post.txt'	# The path of the validation feature vectors generated by opc_trans_sen.py
    ...
    if args.evaluate: #evaluate on valid dataset
