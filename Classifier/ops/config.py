...
parser.add_argument('--hidden', default=384, type=int, help='fc hidden size')
parser.add_argument('-data', metavar='DIR', default='/root/slabt/dataset',
                    help='path to dataset')
parser.add_argument('--depro', default='depro', type=str, help='FeatDe or depro or no')
...
parser.add_argument('-o', '--output', default='De_d', type=str, help='path of outputfile')
...
parser.add_argument ('--n_feature', type=int, default=12, help = 'number of pre-saved features')
...
parser.add_argument ('--dataset', type=str, default="drift", help = '')
